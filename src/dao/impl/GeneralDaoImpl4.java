...
public class GeneralDaoImpl4 implements GeneralDao {

    public static void main(String[] args) {
        GeneralDaoImpl4 dao = new GeneralDaoImpl4();
/*        // 添加成员示
        Member newMember = new Member();
        newMember.setId(1); // 确保这个ID在你的数据库中是唯一的
        newMember.setMBname("TESTJohn Doe");
